  ...
  <Layout>
    <div className="container">
        <div className="row">
            ...
            <div className="blueBackground col-12">
                <p className="customerComment">"Using Smoovey has made life so much easier. <br/> I can focus on X instead of Y, it's amazing."</p>
                <p className="customerName">Joe Bloggs</p>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100"><path fill="#060f3a" fill-opacity="1" d="M0,64L0,96L1440,96L1440,320L0,320L0,320Z"></path></svg>
            </div>
        </div>
    </div>
